...
public class WebDriverUtility {
	...
	/**
	 * This method is used to capture screenshort of the web page 
	 * @param driver
	 * @param className
	 * @param jutil
	 */
	...
	/**
	 * This method is used to scroll till specified element on the web page 
	 * @param element
	 */
	...
	/**
	 * This method is used to switch specified window
	 * @param windowID
	 */
